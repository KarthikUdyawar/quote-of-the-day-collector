...
class QuoteService(AsyncServiceBase[Quote]):
    def __init__(self):
        """
        Initialize the service and bind it to the Quote model.
        """
    ...
    async def total_count(self) -> int:
        """
        Return the total number of records for the service's model.
